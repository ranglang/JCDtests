...
public class ForgetPasswordTest extends BaseTest {
    ...
    private Object[] retrieve_password_use_mail_data(){
        return new Object[]{
                create_retrieve_password_use_mail_data("star003@abc.com")
        };
    }
...
//        this.retrieve_password(accountType ,pwd);
     ...
     */
    @Test
    @Parameters(method = "retrieve_password_use_mail_data")
    public void retrieve_password_use_mail(String mail){
        la.into_forget_password_page();
    ...
    private Object[] create_retrieve_password_use_mail_data(String mail){
